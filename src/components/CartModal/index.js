    ...
    <CommonModal
      ...
      mainContent={
        cartItems && cartItems.length ? (
          <ul role="list" className="-my-6 divide-y divide-pink-700">
            {cartItems.map((cartItem) => (
              <li key={cartItem.id} className="flex py-6">
                ...
                <div className="ml-4 flex flex-1 flex-col">
                  <div>
                    <div className="flex justify-between text-base font-poppins text-gray-900">
                      <h3>
                        <a>
                          {cartItem &&
                            cartItem.productID &&
                  ...
                  <div className="flex flex-1 items-end justify-between text-sm">
                    <button
                      type="button"
                      className="font-poppins text-white bg-pink-700 p-2 rounded-lg sm:order-2"
      ...
      buttonComponent={
        <Fragment>
          ...
          <div className="mt-6 flex justify-center text-center text-sm text-gray-600">
            <button type="button" className="font-poppins text-grey">
              Continue Shopping
